...
public class AccountController extends ABaseController {
    ...
    public void checkCode(HttpServletResponse response, HttpSession session, Integer type) throws
            IOException {
        GifCaptcha vCode = CaptchaUtil.createGifCaptcha(130, 38);
...
File targetFile = new File("D:\\apache-maven-3.9.1\\easypan\\log\\file\\avatar" + "/" + webUserDto.getUserId() + Constants.AVATAR_SUFFIX);        try {
